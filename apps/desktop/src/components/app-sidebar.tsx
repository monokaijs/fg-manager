        ...
        <SidebarMenu>
          <SidebarMenuItem>
            ...
            <div className="flex space-x-2 px-2 pb-4 pt-1">
              ...
              }} className="w-3 h-3 rounded-full bg-rose-500 hover:bg-rose-600 transition-colors shadow-inner border border-rose-600/20 cursor-pointer flex items-center justify-center group z-50">
